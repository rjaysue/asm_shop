...
SHOP    DB 10,13,10,13,'Welcome to the shop!' 
        ...
        DB 10,13,'1. Sanitizer ' 
        DB 10,13,'2. Mask (50 pcs)'
        DB 10,13,'3. Spray  '
        DB 10,13,'4. Set of 5 test kits '  
        
        DB 10,13,10,13,'B) Rice Shop' 
        DB 10,13,'1. Basmati rice (5kg) ' 
        DB 10,13,'2. Local rice (5kg)'
        DB 10,13,'3. Pusa Gold (5kg)  '
        DB 10,13,'4. Fragrant rice (5kg) ' 
        DB 10,13,'$' 
